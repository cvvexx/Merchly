...
public class KafkaErrorHandlingConfig {
     ...
     * (в проде он обычно выключен). Этот сервис слушает order-failed, поэтому его DLT — order-failed.DLT.
     */
    @Bean
    public NewTopic orderFailedDeadLetterTopic(@Value("${app.kafka.topics.order-failed}") String topic) {
